...
	Matrix: This matrix shows how much discount is given in each segment and the discounts affect the sales of product in different segments.
          As we see,in Enterprise segment the discount is given high.
